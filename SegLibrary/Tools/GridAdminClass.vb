...
#Region "Property"
    ...
    Public Property GridEditable As Boolean
...
#Region "Constructor"
    ...
    End Sub
#End Region
    Public Sub AddBanda(ByVal pBand As Short, ByVal pName As String, ByVal Optional pAddButtonCaption As String = "", ByVal Optional pHidden As Boolean = False)
        ConfigBan.Add(New AttBanda(pBand, pName, pAddButtonCaption, pHidden))
    End Sub
...
#Region "Handlers Grid"
    Private Sub m_oGrid_AfterRowInsert(sender As Object, e As RowEventArgs) Handles m_oGrid.AfterRowInsert
        For Each oCell As UltraGridCell In e.Row.Cells
            ...
            End If
        Next
        'If e.Row.Cells.Exists("CreaUserID") Then
        '    e.Row.Cells("CreaUserID").Value = oUsr.UserID
        '    e.Row.Cells("CreaDate").Value = Now()
        '    e.Row.Cells("Activo").Value = RegistroActivoDefault
        'End If
    End Sub
...
#Region "Class"
    Public Class AttBanda
        ...
        Public Sub New(ByVal pBand As Short, ByVal pName As String, ByVal Optional pAddButtonCaption As String = "", ByVal Optional pHidden As Boolean = False)
            Band = pBand
            Name = pName
